...
mod tests {
    ...
    #[test]
    fn tryfrom_arrowfield_adds_metadata() {
        ...
        let converted: schema::SchemaField = field.try_into().unwrap();

        let arrow_type_metadata = converted
            .get_metadata()
            .iter()
        ...
        assert_eq!(actual_arrow_type, field.data_type().clone());
    }
