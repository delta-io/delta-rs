...
Instead, running a query on a partitioned column (`country` in this case) means Daft only has to read the relevant partition, saving us ~60% of the compute. This has huge impacts when you're working at scale.
