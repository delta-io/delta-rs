...
use datafusion::logical_expr::{
    Expr, LogicalPlan, LogicalPlanBuilder, UNNAMED_TABLE, Volatility, col,
};
...
pub(crate) async fn scan_files_where_matches(
    ...
    let files_plan = LogicalPlanBuilder::scan(UNNAMED_TABLE, table_source.clone(), None)?
    ...
    let file_list = valid_files
        ...
        .collect_vec();
    let plan = LogicalPlanBuilder::scan(UNNAMED_TABLE, table_source, None)?
