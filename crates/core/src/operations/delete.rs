...
use datafusion::common::{DFSchema, ScalarValue, exec_datafusion_err};
...
#[allow(clippy::too_many_arguments)]
#[tracing::instrument(skip_all, fields(operation = "delete", version = snapshot.version(), table_uri = %log_store.root_url()))]
async fn execute(
