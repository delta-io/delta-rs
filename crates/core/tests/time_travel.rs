...
async fn time_travel_by_ds() {
    ...
    let log_dir = "../test/tests/data/simple_table_uncommited/_delta_log";
    let log_mtime_pair = vec![
        ...
        (".tmp/00000000000000000004.json", "2020-05-05T22:47:31-07:00"),
    ];
    ...
    let mut table = deltalake_core::open_table_with_ds(
        "../test/tests/data/simple_table_uncommited",
    ...
    // Versions beyond 3 should be ignored.
    // This is an uncommited delta in the .tmp subdirectory
    table = deltalake_core::open_table_with_ds(
        "../test/tests/data/simple_table_uncommited",
